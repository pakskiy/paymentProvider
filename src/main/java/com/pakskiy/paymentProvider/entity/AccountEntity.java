...
public class AccountEntity {
    ...
    @Column(value = "deposit_amount") private Long depositAmount;
    @Column(value = "limit_amount") private Long limitAmount;
    @Column(value = "is_overdraft") private int isOverdraft;
